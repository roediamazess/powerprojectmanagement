...
export default function PartnerSetupIndex({ category, categories, options, pageSearchQuery }) {
    ...
    const filteredOptions = useMemo(() => {
        return filterByQuery(options ?? [], pageSearchQuery, (o) => [o.id, o.name, o.category]);
    ...
    const openCreate = () => {
        ...
        clearErrors();
        reset();
        setData({ category: category ?? 'implementation_type', name: '', status: 'Active' });
        setShowModal(true);
    };
