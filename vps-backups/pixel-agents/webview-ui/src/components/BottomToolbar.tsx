...
export function BottomToolbar({
  ...
  const isPowerpro = typeof window !== 'undefined' && window.location.pathname.startsWith('/agent-working-space');
  ...
  return (
    <div style={panelStyle}>
      <div ref={folderPickerRef} style={{ position: 'relative' }}>
        <button
          onClick={isPowerpro ? handleBack : handleAgentClick}
          onContextMenu={isPowerpro ? undefined : handleAgentRightClick}
        ...
        >
          {isPowerpro ? '← Back' : '+ Agent'}
        </button>
        {!isPowerpro && isBypassMenuOpen && (
          <div
            style={{
              position: 'absolute',
              bottom: '100%',
